...
def chat_interface():
    ...
    st.sidebar.markdown("## 🤖 Chat with our Assistant")
    ...
    # User input
    user_input = st.sidebar.text_input("Ask something...", key="chat_input")
    ...
    if user_input:
        ...
        if response.status_code == 200:
            ...
            bot_reply = "⚠️ Error: Could not connect to chatbot."
...
def main():
    ...
    with st.sidebar:
        ...
        with st.form("search_form"):
            location = st.text_input("Destination", "Anna nagar, Chennai")
